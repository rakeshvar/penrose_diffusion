...
from ...utils.lossy import circle_loss_sincos, equiangle_loss_sincos, lattice_loss, lsa_ordering_scipy, sinkhorn_permutation
...
class NoiseAssistedLoss(AbstractLoss):
    ...
    def compute_loss(self, xysc_0, xysc_t, noise, noise_hat, colors, t):
        ...
        return F.mse_loss(noise, noise_hat) \
            ...
            + .33 * lattice_loss(self.symmetry, xysc_0_hat, self.unit_side)
